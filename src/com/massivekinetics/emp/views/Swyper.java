package com.massivekinetics.emp.views;
...
public class Swyper extends ViewGroup {
	...
	List<OnSwypeCompletedListener> listeners = new ArrayList<OnSwypeCompletedListener>();
	...
	public void addOnSwypeCompletedListener(OnSwypeCompletedListener listener) {
		listeners.add(listener);
	}

	public void removeOnSwypeCompletedListener(OnSwypeCompletedListener listener) {
		listeners.remove(listener);
	}

	protected void notifyOnScreenChange(int newScreenIndex) {
		for (OnSwypeCompletedListener l : listeners) {
			l.onSwypeCompleted(newScreenIndex);
		}
	}
