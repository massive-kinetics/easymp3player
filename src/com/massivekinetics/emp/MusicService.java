...
import com.massivekinetics.emp.remote.RemoteControlClientCompat;
import com.massivekinetics.emp.remote.RemoteControlHelper;
import com.massivekinetics.emp.views.AudioFocusHelper;
...
public class MusicService extends Service implements OnCompletionListener, OnPreparedListener,
    ...
    ProviderMusicManager mMusicManager;
    
    EMPMusicController musicController = EMPApplication.context.getMusicController();
 ...
 //   Bitmap mDummyAlbumArt;
    ...
    public void onCreate() {
        ...
        mMusicManager = new ProviderMusicManager();
        (new PrepareMusicRetrieverTask(mMusicManager,this)).execute();
